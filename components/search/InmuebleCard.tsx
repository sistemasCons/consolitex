...
export const CaracteristicaContainer: FC<IconContainer> = ({
  icon,
  conditionalText,
}) => {
  return (
        ...
        <Grid container flexWrap="wrap" justifyContent="space-between">
          ...
          <Grid item xs={12} sm={4}>
            ...
            >
              ...
              <Image
                alt={data.nombre}
                src={`https://images.consolitex.org/newImg.php?nowatermark=1&url=${encodeURI(
                  url_inmueble
                )}`}
                layout="fill"
                loading="lazy"
          ...
          >
            ...
            <Box sx={styles.codContainer}>
              ...
              <Chip
                ...
                color="primary"
                size="small"
                label={`${ucfirst(data.inmueble.toLowerCase())} ${
                  data.ficha_id0
                }`}
                sx={{ fontSize: 11 }}
              />
              ...
              <Tooltip title={ucfirst(data.descripcion_web.toLowerCase())}>
                <Typography variant="body1" sx={{ textAlign: "justify" }}>
                  {data.descripcion_web.length > 90
                    ? ucfirst(
                        data.descripcion_web.toLowerCase().substring(0, 90)
                      ) + "..."
